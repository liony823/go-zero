...
If you have questions or need guidance at any stage, don't hesitate to [open an issue](https://github.com/liony823/go-zero/issues/new/choose).
...
Discover easy-entry issues labeled as [help wanted](https://github.com/liony823/go-zero/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22) or [good first issue](https://github.com/liony823/go-zero/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22). These issues are perfect for newcomers and don't require deep knowledge of the system. We're here to assist you with these tasks.
...
Reporting an issue is just as valuable as code contributions. If you discover a problem, don't hesitate to [open an issue](https://github.com/liony823/go-zero/issues/new/choose). Be sure to follow our guidelines when submitting an issue.
...
4. 📦 Submit a Pull Request: When your creation is complete, submit a Pull Request to the [go-zero repository](https://github.com/liony823/go-zero).
